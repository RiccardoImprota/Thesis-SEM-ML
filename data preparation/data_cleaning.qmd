...
There's a bunch of outliers that were removed based on a z-score method.
...
```{r}
write_spss(df, "processeddata//df.sav")
write_csv(df_numeric, "processeddata//df_numeric.csv")
```
...
write_csv(var_info, "processeddata//var_info.csv")
